        ...
        <div class="Scroll-container">
            <div class="Background first" ref={ref1}>
                ...
                <span class="Dot reveal">
                    <img class="image1 reveal" src="Headshot.png" alt="Char" width="200" height="200"></img>
                </span>
            </div>
            ...
            <div class="Background second">
                <p>Programmer</p>
                <span class="Dot">
                    <img class="image2" src="Headshot.png" alt="Eevee" width="200" height="200"></img>
                </span>
            </div>
            <div class="Spacer"></div>
            <div class="Background third">
                <p>Creator</p>
                <span class="Dot">
                    <img class="image3" src="Headshot.png" alt="Pika" width="200" height="200"></img>
                </span>
            </div>
        </div>
    )
